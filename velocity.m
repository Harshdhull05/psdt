classdef velocity < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.LowervalueofvEditFieldLabel.Position = [151 343 92 22];
            ...
            app.UppervalueofvEditFieldLabel.Position = [147 303 96 22];
            ...
            app.VelocityParameterLabel.Position = [242 417 106 22];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = velocity(varargin)
