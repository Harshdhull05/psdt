classdef time_exported < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.LowervalueoftEditFieldLabel.FontWeight = 'bold';
            app.LowervalueoftEditFieldLabel.Position = [150 359 100 22];
            ...
            app.LowervalueoftEditField.FontWeight = 'bold';
            ...
            app.UppervalueoftEditFieldLabel.FontWeight = 'bold';
            app.UppervalueoftEditFieldLabel.Position = [154 319 96 22];
            ...
            app.UppervalueoftEditField.FontWeight = 'bold';
            app.UppervalueoftEditField.Position = [265 319 100 22];

            % Create TimeParameterLabel
            app.TimeParameterLabel = uilabel(app.UIFigure);
            app.TimeParameterLabel.FontWeight = 'bold';
            app.TimeParameterLabel.Position = [232 435 95 22];
    ...
    methods (Access = public)
        ...
        % Construct app
        function app = time_exported(varargin)
